...
export function DetailedTechnicians(){
  ...
  return (
    <div className="w-screen h-screen  xl:grid xl:grid-cols-[280px_1fr] bg-gray-100 xl:overflow-hidden">
      ...
      <form onSubmit={onSubmit} className="w-full  flex flex-col   xl:px-14 gap-4 bg-white absolute xl:relative py-24  rounded-3xl xl:rounded-none xl:rounded-tl-2xl mt-28  xl:mt-4">
